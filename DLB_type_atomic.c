/*
*       description: usage of LDB atomic queue, checking FlowID parameter
*       author: jseroczy
*/
    ...
    dlb_dev dlb)
{
    ...
    args.num_ldb_queues = RX_TH_NUM;
    args.num_ldb_ports = RX_TH_NUM + 1;
...
/////////////////////////////////////////////////////////////////////////////////////////////
    ...
    rx_args.queue_id = create_ldb_queue(domain, -1);
